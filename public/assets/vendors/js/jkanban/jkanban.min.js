                    ...
                    this.jKanban = function () {
                        ...
                        var i = {
                            ...
                            dropBoard: function (e, t, n, o) { 
                                var drop_board = $('.kanban-board');
                                let drop_length = drop_board.length;
                                let drop_board_array = [];
                                drop_board.each(function(index, value ) {
                                    let array = [];
                                    if(index == drop_length){
                                        break;
                                    }
                                    //console.log($(this).find('.kanban-board').prevObject[0].attributes['data-id'] , $(this).find('.kanban-board').prevObject[0].attributes['data-order']);
                                    array['id'] = $(this).find('.kanban-board').prevObject[0].attributes['data-id'];
                                    array['ordering'] = $(this).find('.kanban-board').prevObject[0].attributes['data-order'];
                                   
                                });
                                console.log(drop_board_array);
