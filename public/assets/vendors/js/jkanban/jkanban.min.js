                        ...
                        var i = {
                            ...
                            dropBoard: function (e, t, n, o) { 
                                ...
                                drop_board.each(function(index, value ) {
                                    ...
                                    console.log($(n).find('.kanban-board')[0].attributes['data-id']);
                                    console.log($(n).find('.kanban-board')[0].attributes['data-order']);
                                    // console.log($(this).find('.kanban-board').prevObject[0].attributes[1].value);
                                    arrange_board.push({
                                        id: $(this).find('.kanban-board').prevObject[0].attributes[0].value,
                                        ordering: $(this).find('.kanban-board').prevObject[0].attributes[1].value,
                                    });
