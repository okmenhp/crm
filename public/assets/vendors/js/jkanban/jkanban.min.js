                ...
                !(function () {
                    this.jKanban = function () {
                        ...
                        var i = {
                            ...
                            itemAddOptions: n,
                            itemHandleOptions: t,
                            dragEl: function (e, t) {},          //click 1 thẻ
                            dragendEl: function (e) {},       //Thả 1 thẻ
                            dropEl: function (e, t, n, o) {},         //SK sau khi thả 1 thẻ
                            dragBoard: function (e, t) { },            //click vào 1 list
                            dragendBoard: function (e) {},                      //thả 1 list
                            dropBoard: function (e, t, n, o) { 
                                let drop_board = $('.kanban-board');
                                //console.log( drop_board[0]);
                                let drop_length = drop_board.length;
                                let arrange_board = [];
                                drop_board.each(function(index, value ) {
                                    if(index == drop_length-1){
                                        return;
                                    }
                                    console.log($(this).find('.kanban-board').prevObject[0].attributes['data-id']['value']);
                                    console.log($(this).find('.kanban-board').prevObject[0].attributes['data-order']['value']);
                                    arrange_board.push({
                                        id: $(this).find('.kanban-board').prevObject[0].attributes['data-id']['value'],
                                        ordering: $(this).find('.kanban-board').prevObject[0].attributes['data-order']['value'],
                                    });
                                    
                                   //console.log(arrange_board);
                                 
                                });
                                // $.ajax({
                                //   type: "post",
                                //   url: '/api/kanban/arrange-board',
                                //   data: {
                                //     arrange_board: arrange_board,
                                //   }
                                // }).done(function(resp) {
                            ...
                            },      //Xử lý sau khi thả 1 list
                            //console.log('dropE', $(e).find('.kanban-board').prevObject[0].attributes['data-id']['value']);
                            click: function (e) {},
                                ...
                                !(function () {
                                              ...
                                              window
                                                  ...
                                                  .then((t) => {
                                                      t.json().then(function (t) {
                                                          console.log(t), (e.options.boards = t), e.addBoards(e.options.boards, !0);
                                                      });
                                                  })
                                                  .catch((e) => {
                                                      console.log("Error: ", e);
                                    ...
                                    window.innerWidth > e.options.responsive &&
                                        ((e.drakeBoard = e
                                            ...
                                            .on("drag", function (t, n) {  //nếu drag card add thêm class is-moving
                                                t.classList.add("is-moving"), e.options.dragBoard(t, n), "function" == typeof t.dragfn && t.dragfn(t, n);
                                            })
                                            .on("dragend", function (t) { //thả chuột board
                                                !(function () {
                                            ...
                                            .on("drop", function (t, n, o, i) {     //sau khi thả chuột board                           
                                        ...
                                        (e.drake = e
                                            ...
                                            .on("drag", function (t, n) {   //click vào card
                                            ...
                                            .on("dragend", function (t) { //thả chuột 1 card
                                                e.options.dragendEl(t), null !== t && "function" == typeof t.dragendfn && t.dragendfn(t);
                                            })
                                            .on("drop", function (t, n, o, i) {  //drop card
                                                e.enableAllBoards();
                                                var r = d(o.parentNode.dataset.id); //lấy id board
                            ...
                            return function () {
                                ...
                                return (
                                    a.forEach(function (o) {
                                        n.async ? i(o, r, d) : o.apply(d, r), o._once && e.off(t, o);
                                    }),
                                    e
                                );
                            };
                ...
                (function (n) {
                    ...
                    function s(e, t, n) {
                        var o = (function (e, t, n) {
                            var o, i;
                            for (o = 0; o < c.length; o++) if ((i = c[o]).element === e && i.type === t && i.fn === n) return o;
                        })(e, t, n);
                        if (o) {
                            var i = c[o].wrapper;
                        ...
                        ((a = function (e, t, o) {
                            return e.attachEvent(
                                ...
                                (function (e, t, o) {
                                    ...
                                    return c.push({ wrapper: i, element: e, type: t, fn: o }), i;
                                })(e, t, o)
                            );
                        }),
                        (d = function (e, t, n) {
            ...
            function (e, t, n) {
                (function (n) {
                    ...
                    t.exports = function (e, t) {
                        ...
                        function D(e) {
                            var t = e ? "remove" : "add";
                            i[t](d, "selectstart", M), i[t](d, "click", M);
                        }
                        function M(e) {
                            N && e.preventDefault();
                        }
                        ...
                        function Y(e) {
                            if (N)
                                if (0 !== s(e)) {
                                    if (void 0 === e.clientX || e.clientX !== O || void 0 === e.clientY || e.clientY !== k) {
                        ...
                        function j(e) {
                            if (!((_.dragging && n) || H(e))) {
                                ...
                                var o = h(e);
                                if (o && !A.invalid(e, t) && A.moves(e, o, t, b(e))) return { item: e, source: o };
                            }
                        }
                        function F(e) {
                            var t, n;
                        ...
                        function V() {
                            var e = L || E;
                            U(),
                                n && (r.rm(A.mirrorContainer, "gu-unselectable"), c(d, "remove", "mousemove", Q), h(n).removeChild(n), (n = null)),
                                e && r.rm(e, "gu-transit"),
                                B && clearTimeout(B),
                                (_.dragging = !1),
                                I && _.emit("out", e, I, w),
                        ...
                        function Q(e) {
                            if (n) {
                                ...
                                if (c !== w || !L || A.copySortSource) {
                                    ...
                                    ((null === f && s) || (f !== a && f !== b(a))) && ((x = f), c.insertBefore(a, f), _.emit("shadow", a, c, w));
                        ...
                        function ee(e, t, n, o) {
                            ...
                            return t !== e
                                ? ((i = t.getBoundingClientRect()), a(r ? n > i.left + m(i) / 2 : o > i.top + v(i) / 2))
                                : (function () {
                                      var t,
                                          i,
                                          a,
                    ...
                    if (!u) {
                        ...
                        (s = null),
                            ...
                            (function (e) {
                                ...
                                if ((i === d || !i) && clearTimeout) return (i = clearTimeout), clearTimeout(e);
                                try {
                                    i(e);
                                } catch (t) {
                                    try {
                            ...
                            "function" == typeof t
                                ...
                                : function (e) {
                                      ...
                                      return (
                                          (d[t] = !0),
                                          i(function () {
                                              d[t] && (o ? e.apply(null, o) : e.call(null), n.clearImmediate(t));
                                          }),
                                          t
                                      );
                                  }),
