                                    ...
                                    <div class="card-body">
                                        <form action="/position">
                                            <div class="form-group mb-50">
                                                <label class="text-bold-600" for="exampleInputEmail1">Địa chỉ
                                                    Email</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    placeholder="Nhập địa chỉ email">
                                            </div>
                                            <div class="form-group">
                                                <label class="text-bold-600" for="exampleInputPassword1">Mật
                                                    khẩu</label>
                                            ...
                                            <button type="submit"
                                                class="btn btn-primary glow w-100 position-relative">Đăng nhập<i
