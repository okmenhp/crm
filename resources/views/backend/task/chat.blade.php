        ...
        <div class="sidebar">
          ...
          <div class="chat-user-profile">
            <header class="chat-user-profile-header text-center border-bottom">
              ...
              <div class="my-2">
                <div class="avatar">
                  <img src="../../../app-assets/images/portrait/small/avatar-s-11.jpg" alt="user_avatar" height="100"
                    width="100">
                </div>
              ...
              <div class="chat-user-profile-scroll">
                ...
                <ul class="list-unstyled">
                  <li class="mb-50 "><a href="javascript:void(0);" class="d-flex align-items-center"><i
                        class="bx bx-tag mr-50"></i> Add
                      Tag</a></li>
                  <li class="mb-50 "><a href="javascript:void(0);" class="d-flex align-items-center"><i
                        class="bx bx-star mr-50"></i>
                      Important Contact</a>
                  </li>
                  <li class="mb-50 "><a href="javascript:void(0);" class="d-flex align-items-center"><i
                        class="bx bx-image-alt mr-50"></i>
                      Shared
                      Documents</a></li>
                  <li class="mb-50 "><a href="javascript:void(0);" class="d-flex align-items-center"><i
                        class="bx bx-trash-alt mr-50"></i>
                      Deleted
                      Documents</a></li>
                  <li><a href="javascript:void(0);" class="d-flex align-items-center"><i class="bx bx-block mr-50"></i>
                      Blocked
                      Contact</a></li>
                </ul>
              </div>
          ...
          <div class="chat-sidebar card">
            ...
            <div class="chat-sidebar-search">
              <div class="d-flex align-items-center">
                <div class="chat-sidebar-profile-toggle">
                  <div class="avatar">
                    <img src="../../../app-assets/images/portrait/small/avatar-s-11.jpg" alt="user_avatar" height="36"
                      width="36">
                  </div>
                </div>
            ...
            <div class="chat-sidebar-list-wrapper pt-2">
              ...
              <ul class="chat-sidebar-list">
                <li>
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-50"><img src="../../../app-assets/images/portrait/small/avatar-s-26.jpg"
                ...
                <li>
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-50"><img src="../../../app-assets/images/portrait/small/avatar-s-7.jpg"
                        height="36" width="36" alt="sidebar user image">
              ...
              <ul class="chat-sidebar-list">
                <li>
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-50"><img src="../../../app-assets/images/portrait/small/avatar-s-8.jpg"
                        height="36" width="36" alt="sidebar user image">
                ...
                <li>
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-50"><img src="../../../app-assets/images/portrait/small/avatar-s-5.jpg"
                        height="36" width="36" alt="sidebar user image">
                      <span class="avatar-status-online"></span>
                    </div>
                    <div class="chat-sidebar-name">
                ...
                <li>
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-50"><img src="../../../app-assets/images/portrait/small/avatar-s-9.jpg"
                        height="36" width="36" alt="sidebar user image">
                      <span class="avatar-status-busy"></span>
                    </div>
                    <div class="chat-sidebar-name">
                ...
                <li>
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-50"><img src="../../../app-assets/images/portrait/small/avatar-s-14.jpg"
                        height="36" width="36" alt="sidebar user image">
                      <span class="avatar-status-online"></span>
                    </div>
                    <div class="chat-sidebar-name">
                ...
                <li>
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-50"><img src="../../../app-assets/images/portrait/small/avatar-s-3.jpg"
                        height="36" width="36" alt="sidebar user image">
                      <span class="avatar-status-offline"></span>
                    </div>
                    <div class="chat-sidebar-name">
          ...
          <div class="content-body">
                    ...
                    <div class="chat-header-icons">
                      ...
                      <span class="dropdown">
                        ...
                        <span class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item" href="JavaScript:void(0);"><i class="bx bx-pin mr-25"></i> Pin to
                            top</a>
                          <a class="dropdown-item" href="JavaScript:void(0);"><i class="bx bx-trash mr-25"></i> Delete
                            chat</a>
                          <a class="dropdown-item" href="JavaScript:void(0);"><i class="bx bx-block mr-25"></i>
                            Block</a>
                        </span>
                      </span>
                    </div>
                  ...
                  <div class="card-body chat-container">
                    <div class="chat-content">
                      ...
                      <div class="chat chat-left">
                        <div class="chat-avatar">
                          <a class="avatar m-0">
                            <img src="../../../app-assets/images/portrait/small/avatar-s-26.jpg" alt="avatar"
                              height="36" width="36" />
                          </a>
                        </div>
                        <div class="chat-body">
            ...
            <section class="chat-profile">
              <header class="chat-profile-header text-center border-bottom">
                ...
                <div class="my-2">
                  <div class="avatar">
                    <img src="../../../app-assets/images/portrait/small/avatar-s-26.jpg" alt="chat avatar" height="100"
                      width="100">
                  </div>
