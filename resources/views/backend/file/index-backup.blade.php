                            ...
                            <div class="card shadow-none mb-0 p-0 pb-1">
                                ...
                                <ul class="nav nav-tabs justify-content-center" role="tablist">
                                    ...
                                    <li class="nav-item pt-50 ">
                                        <a class=" nav-link d-flex align-items-center" id="activity-tab"
                                            data-toggle="tab" href="#activity" aria-controls="activity" role="tab"
                                            aria-selected="false">
                                ...
                                <div class="tab-content pl-0">
                                    ...
                                    <div class="tab-pane pl-0" id="activity" aria-labelledby="activity-tab"
                                        role="tabpanel">
                                        <div class="card-body">
                                            <ul class="timeline mb-0">
                                                ...
                                                <li class="timeline-item timeline-icon-info active">
                                                    ...
                                                    <div class="timeline-content">
                                                        <img src="assets/images/icon/sketch.png" alt="Sketch"
                                                            height="30" width="25" class="mr-50">Template_Design.sketch
                                                    </div>
                                                </li>
                            ...
                            <div class="app-file-area">
                                    ...
                                    <div class="app-file-header-search flex-grow-1">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left m-0">
                                            <input type="text" class="form-control border-0 shadow-none"
                                                id="file-search" placeholder="Tìm kiếm">
                                ...
                                <div class="app-file-content p-2">
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.file.index', 0)}}">File
                                                    của
                                                    tôi</a></li>
                                            @if(isset($breadcumb))
                                        ...
                                        <div class="col-lg-3 col-md-4 col-6">
                                                ...
                                                <div class="card-body px-75 py-50">
                                                    <div class="app-file-folder-content d-flex align-items-center">
                                                        ...
                                                        <div class="app-file-folder-details">
                                                            ...
                                                            <div
                                                                class="app-file-folder-size font-size-small text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-sm context-menu">
                                                ...
                                                <a class="dropdown-item modal-share-file"
                                                    data-share="{{$record_folder->share}}"
                                                    data-id="{{$record_folder->id}}" data-share_type="{{$record_folder->share_type
                                                ...
                                                <a class="dropdown-item modal-info-file" data-toggle="modal"
                                                    data-target="#modaInfoFile" data-id="{{$record_folder->id}}"
                                                    href="#"><i class="fas fa-file-alt"></i>&nbsp; Thông tin</a>
                                                ...
                                                <form method="post"
                                                    ...
                                                    @csrf
                                                    <button class="btn btn-delete text-left" style="width: 100%;"
                                                        type="submit"><i class="fa fa-trash" aria-hidden="true">&nbsp;
                                                            <span style="font-weight: 500;">XOÁ</span></i></button>
                                                </form>
                                            </div>
                                        </div>
                                        @endforeach
                                            ...
                                            <div class="card border shadow-none mb-1 app-file-info">
                                                <div class="app-file-content-logo card-img-top">
                                                    ...
                                                    <img class="d-block mx-auto icon-image"
                                                        src="{{ Storage::url($record_file->link) }}"
                                                        alt="Card image cap">
                                                    ...
                                                    <img class="d-block mx-auto"
                                                        src="{{asset('assets/images/file/pdf.png')}}" height="80"
                                                        width="55" alt="Card image cap">
                                                    @else
                                                    <img class="d-block mx-auto"
                                                ...
                                                <<<<<<< HEAD <a class="dropdown-item"
                                                    ...
                                                    <a class="dropdown-item" data-id="{{$record_file->id}}"
                                                        href="{{route('admin.file.dowload', $record_file->id)}}"><i
                                                            class="fa fa-download" aria-hidden="true"></i>&nbsp; Tải
                                                        xuống</a>
                                                    <a class="dropdown-item modal-rename" data-id="{{$record_file->id}}"
                                                        data-toggle="modal" data-target="#modalRename" href="#"><i
                                                            class="fas fa-edit"></i>&nbsp; Đổi tên</a>
                                                    <a class="dropdown-item modal-share-file"
                                                        data-share="{{$record_file->share}}"
                                                        data-id="{{$record_file->id}}" data-share_type="{{$record_file->share_type
                                           }}" data-toggle="modal" data-target="#modalShareFile" href="#"><i
                                                            class="fas fa-edit"></i>&nbsp; Chia sẻ</a>
                                                    <a class="dropdown-item modal-info-file" data-toggle="modal"
                                                        data-target="#modaInfoFile" data-id="{{$record_file->id}}"
                                                        href="#"><i class="fas fa-file-alt"></i>&nbsp; Thông tin</a>
                                                    @if(Request::get('is_bin') == 1)
                                                    <form method="post"
                                                        ...
                                                        <a class="dropdown-item modal-view-file" data-toggle="modal"
                                                            data-target="#modalViewFile" data-id="{{$record_file->id}}"
                                                            href="#"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;
                                                            Mở</a>
                                                        @endif
                                                        <a class="dropdown-item" data-id="{{$record_file->id}}"
                                                            href="{{route('admin.file.dowload', $record_file->id)}}"><i
                                                                class="fa fa-download" aria-hidden="true"></i>&nbsp; Tải
                                                            xuống</a>
                                                        <a class="dropdown-item modal-rename"
                                                            data-id="{{$record_file->id}}" data-toggle="modal"
                                                            data-target="#modalRename" href="#"><i
                                                                class="fas fa-edit"></i>&nbsp; Đổi tên</a>
                                                        <a class="dropdown-item modal-share-file"
                                                            data-share="{{$record_file->share}}"
                                                            data-id="{{$record_file->id}}" data-share_type="{{$record_file->share_type
                                                        ...
                                                        <form method="post"
                                                            ...
                                                            >>>>>>> origin/main
                                                            @csrf
                                                            <button class="btn btn-delete text-left"
                                                                style="width: 100%;" type="submit"><i
                                                                    class="fas fa-sync-alt">&nbsp; <span
                                                                        style="font-weight: 500;">KHÔI
                                                                        PHỤC</i></span></button>
                                                        </form>
                                                        @endif
                                                        <form method="post"
