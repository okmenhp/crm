                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls row">
                                                        <img height="200px" width="200px"
                                                            src="{{ asset('assets/images/profile/account.png') }}"
                                                            class="img-thumbnail ml-1" alt="...">
                                                        <div class="mb-3 ml-1">
                                            ...
                                            <div class="col-10 col-sm-10 row">
                                                <div class="col-6 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Tên người dùng<span class="text-danger">
                                                                    *</span></label>
                                                ...
                                                <div class="col-6 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Nhập lại mật khẩu<span class="text-danger">
                                                                    *</span></label>
                                                            <input type="password" class="form-control" value=""
                                                                name="c_password">
                                                ...
                                                <div class="col-6 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Chọn phòng ban <span class="text-danger">
                                                                    *</span></label>
                                                ...
                                                <div class="col-6 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Chọn chức vụ <span class="text-danger">
                                                                    *</span></label>
