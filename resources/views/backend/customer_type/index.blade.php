                    ...
                    <div class="users-list-filter px-1">
                        <form>
                            <div class="row border rounded  mb-2">
                                <form action="{{ route('admin.customer_type.index') }}" method="get">
                                            ...
                                            <tbody>
                                                @foreach ($records as $key => $record)
                                                    <tr>
                                                        ...
                                                        <td><a
                                                                href="{{ route('admin.customer_type.edit', $record->id) }}"><i
                                                                    class="far fa-edit"></i></a>
                                                            <form style="display: inline-block" method="POST"
                                                                action="{{ route('admin.customer_type.destroy', $record->id) }}">
                                                                @csrf
