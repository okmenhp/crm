...
Route::post('project/gantt','Api\ProjectController@gantt')->name('api.project.gantt');
Route::post('project/gantt-update','Api\ProjectController@ganttUpdate')->name('api.project.ganttUpdate');
